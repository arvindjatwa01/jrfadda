...
const BannerMaster = () => {
    return (
        <div className="bg-gradient-to-b from-blue-100 to-white">
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 items-center gap-8 py-6 lg:py-12">
            ...
            <div className="hidden lg:block text-center bg-[url('/images/sea-banner.png')] relative w-full min-h-[400px] bg-cover bg-no-repeat px-8 py-6 lg:py-12">
                <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-10 absolute top-5 translate-y-1/2">
